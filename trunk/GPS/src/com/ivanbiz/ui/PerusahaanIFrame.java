...
/*
 * PerusahaanIFrame.java
 *
 * Created on 06 Sep 14, 9:18:56
 */
 ...
 */
public class PerusahaanIFrame extends javax.swing.JInternalFrame {

    Perusahaan perusahaan;
    PerusahaanDAO perusahaanDAO;
    List<Perusahaan> listPerusahaan;

    /** Creates new form PerusahaanIFrame */
    public PerusahaanIFrame(List<AksesMatrix> listAksesMatrix) {
        initComponents();
        perusahaanDAO = new PerusahaanDAOImpl();
        refresh();
    }

    public PerusahaanIFrame() {
        initComponents();
        perusahaanDAO = new PerusahaanDAOImpl();
        refresh();
    }
    ...
    private void initComponents() {
        ...
        setBounds((screenSize.width-416)/2, (screenSize.height-410)/2, 416, 410);
    ...
    private void refresh() {
        try {
            ...
            Logger.getLogger(PerusahaanIFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
