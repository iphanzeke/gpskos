 ...
 */
public class BiayaLainSumDialog extends javax.swing.JDialog {

    public BiayaLainSumDialog() {
        initComponents();
        refresh();
    }
    ...
    private void buttonLihatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonLihatActionPerformed
        try {
            new BiayaLainSumReportDialog(jDateChooserDariTanggal.getDate(), jDateChooserSampaiTanggal.getDate()).setVisible(true);
        } catch (Exception ex) {
            Logger.getLogger(BiayaLainSumDialog.class.getName()).log(Level.SEVERE, null, ex);
        }
