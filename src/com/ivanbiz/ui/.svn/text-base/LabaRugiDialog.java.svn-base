 ...
 * LabaRugiDialog.java
 *
 * Created on Aug 7, 2015, 1:43:29 PM
 */
 ...
 * @author IW20149X
 */
public class LabaRugiDialog extends javax.swing.JDialog {

    /** Creates new form LabaRugiDialog */
    public LabaRugiDialog() {
        initComponents();
        refresh();
    }
    ...
    private void initComponents() {
        ...
        setBounds((screenSize.width-416)/2, (screenSize.height-232)/2, 416, 232);
    }// </editor-fold>//GEN-END:initComponents

    private void buttonLihatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonLihatActionPerformed
        new LabaRugiReportDialog(jDateChooserDariTanggal.getDate(), jDateChooserSampaiTanggal.getDate()).setVisible(true);
